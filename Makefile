...
SRC = main.cpp constants.cpp board.cpp ai.cpp input.cpp ui.cpp zobrist.cpp tt.cpp
HEADERS = constants.hpp board.hpp ai.hpp input.hpp ui.hpp zobrist.hpp tt.hpp
OUT = main
