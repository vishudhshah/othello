...
SRC = main.cpp constants.cpp board.cpp ai.cpp input.cpp ui.cpp zobrist.cpp tt.cpp bitboard.cpp book.cpp
HEADERS = constants.hpp board.hpp ai.hpp input.hpp ui.hpp zobrist.hpp tt.hpp bitboard.hpp book.hpp
OUT = main
